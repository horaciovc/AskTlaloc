...
public class GoogleStaticMap : MonoBehaviour {
	...
	public GameObject FindWater;
	public GameObject arrow;
	public GameObject civil;

	private Vector3 posWater = new Vector3(-16.7f,0.5f,-15.4f);
...
//			importer.isReadable = true;
			...
			FindWater.transform.position = posWater;
			//renderer.material.mainTexture = www.textureNonReadable;
			isDrawn = true;

			map2d = renderer.material.mainTexture as Texture2D;

			arrow.SetActive (true);
			arrow.transform.position = civil.transform.position;
			arrow.transform.eulerAngles = new Vector3 (arrow.transform.eulerAngles.x, -170f, arrow.transform.eulerAngles.z);
			//arrow.transform.localEulerAngles.y = 
